...
void TagToken::appendName(wchar_t c) { m_name += c; }
...
void CommentToken::appendData(wchar_t c) { m_data += c; }

DoctypeToken::DoctypeToken(wchar_t c) : m_name(std::wstring(1, c)) {}
...
void DoctypeToken::appendName(wchar_t c) { m_name += c; }
